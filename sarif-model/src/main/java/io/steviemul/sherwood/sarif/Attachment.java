...
@JsonPropertyOrder({"description", "artifactLocation", "regions", "rectangles", "properties"})
...
public class Attachment {
  ...
  /**
   * @param regions An array of regions of interest within the attachment.
   * @param rectangles An array of rectangles specifying areas of interest within the image.
   * @param description A message describing the role played by the attachment.
   * @param artifactLocation The location of the attachment.
   * @param properties Key/value pairs that provide additional information about the attachment.
   */
  public Attachment(
      Message description,
  ...
  public boolean equals(Object other) {
    ...
    return ((((((this.description == rhs.description)
                    ...
                    && ((this.regions == rhs.regions)
                        || ((this.regions != null) && this.regions.equals(rhs.regions))))
                && ((this.rectangles == rhs.rectangles)
                    || ((this.rectangles != null) && this.rectangles.equals(rhs.rectangles))))
            && ((this.artifactLocation == rhs.artifactLocation)

...
@JsonPropertyOrder({"text", "markdown", "properties"})
@Generated("jsonschema2pojo")
public class MultiformatMessageString {

  /** A plain text message string or format string. (Required) */
  @JsonProperty("text")
  ...
  /**
   * @param markdown A Markdown message string or format string.
   * @param text A plain text message string or format string.
   * @param properties Key/value pairs that provide additional information about the message.
   */
  ...
  public String toString() {
    ...
    sb.append(MultiformatMessageString.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((this.markdown == rhs.markdown)
                || ((this.markdown != null) && this.markdown.equals(rhs.markdown)))

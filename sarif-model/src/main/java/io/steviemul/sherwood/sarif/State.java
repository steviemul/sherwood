 ...
 * which represents the variable or expression value. For an annotation of kind 'continuation', for
 * example, this dictionary might hold the current assumed values of a set of global variables.
 */

...
@JsonPropertyOrder({"address", "artifactLocation", "region", "contextRegion", "properties"})
...
public class PhysicalLocation {
   ...
   * @param contextRegion Specifies a portion of the artifact that encloses the region. Allows a
   *     viewer to display additional context around the region.
   * @param region Specifies a portion of the artifact.
   * @param artifactLocation The location of the artifact.
   * @param properties Key/value pairs that provide additional information about the physical
   *     location.
   */
  public PhysicalLocation(
      Address address,
  ...
  public String toString() {
    ...
    sb.append(PhysicalLocation.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((((this.contextRegion == rhs.contextRegion)
                        || ((this.contextRegion != null)
                            && this.contextRegion.equals(rhs.contextRegion)))
                    && ((this.address == rhs.address)
                        || ((this.address != null) && this.address.equals(rhs.address))))
                && ((this.region == rhs.region)
                    || ((this.region != null) && this.region.equals(rhs.region))))

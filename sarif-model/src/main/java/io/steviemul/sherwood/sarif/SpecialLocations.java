...
@JsonPropertyOrder({"displayBase", "properties"})
...
public class SpecialLocations {
  ...
  /**
   * @param displayBase Provides a suggestion to SARIF consumers to display file paths relative to
   *     the specified location.
   * @param properties Key/value pairs that provide additional information about the special
   *     locations.
   */
  ...
  public String toString() {
    ...
    sb.append(SpecialLocations.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return (((this.displayBase == rhs.displayBase)
            || ((this.displayBase != null) && this.displayBase.equals(rhs.displayBase)))

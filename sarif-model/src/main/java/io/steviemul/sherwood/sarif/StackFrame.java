...
public class StackFrame {
  ...
  /**
   * @param threadId The thread identifier of the stack frame.
   * @param module The name of the module that contains the code of this stack frame.
   * @param location The location to which this stack frame refers.
   * @param parameters The parameters of the call that is executing.
   * @param properties Key/value pairs that provide additional information about the stack frame.
   */
  public StackFrame(
      Location location,
      String module,
  ...
  public StackFrame withThreadId(Long threadId) {
    this.threadId = threadId;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(StackFrame.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((((this.threadId == rhs.threadId)
                        || ((this.threadId != null) && this.threadId.equals(rhs.threadId)))
        ...
        && ((this.module == rhs.module)
            || ((this.module != null) && this.module.equals(rhs.module))));
  }
}

...
@JsonPropertyOrder({"id", "index", "guid", "toolComponent", "properties"})
...
public class ReportingDescriptorReference {
  ...
  /**
   * @param index The index into an array of descriptors in toolComponent.ruleDescriptors,
   *     toolComponent.notificationDescriptors, or toolComponent.taxonomyDescriptors, depending on
   *     context.
   * @param guid A guid that uniquely identifies the descriptor.
   * @param toolComponent A reference used to locate the toolComponent associated with the
   *     descriptor.
  ...
  public ReportingDescriptorReference withIndex(Long index) {
    this.index = index;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(ReportingDescriptorReference.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((((this.index == rhs.index) || ((this.index != null) && this.index.equals(rhs.index)))
                ...
                && ((this.toolComponent == rhs.toolComponent)
                    || ((this.toolComponent != null)
                        && this.toolComponent.equals(rhs.toolComponent))))

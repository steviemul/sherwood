...
@JsonPropertyOrder({"description", "artifactChanges", "properties"})
...
public class Fix {
  ...
  /** One or more artifact changes that comprise a fix for a result. (Required) */
   ...
   * @param description A message that describes the proposed fix, enabling viewers to present the
   *     proposed change to an end user.
   * @param properties Key/value pairs that provide additional information about the fix.
   */
  ...
  public int hashCode() {
    int result = 1;
    result =
        ((result * 31) + ((this.artifactChanges == null) ? 0 : this.artifactChanges.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    Fix rhs = ((Fix) other);
    return ((((this.artifactChanges == rhs.artifactChanges)
                || ((this.artifactChanges != null)
                    && this.artifactChanges.equals(rhs.artifactChanges)))

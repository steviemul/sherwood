...
@JsonPropertyOrder({"enabled", "level", "rank", "parameters", "properties"})
...
public class ReportingConfiguration {
   ...
   * @param rank Specifies the relative priority of the report. Used for analysis output only.
   * @param parameters Contains configuration information specific to a report.
   * @param enabled Specifies whether the report may be produced during the scan.
  ...
  public String toString() {
    ...
    sb.append(ReportingConfiguration.class.getName())
        .append('@')
  ...
  public enum Level {
    ...
    private static final Map<String, ReportingConfiguration.Level> CONSTANTS =
        new HashMap<String, ReportingConfiguration.Level>();

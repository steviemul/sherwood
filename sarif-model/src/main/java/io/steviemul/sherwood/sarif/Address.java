...
public class Address {
     ...
     *     The address expressed as a byte offset from the start of the addressable region.
     */
    public Address(Long absoluteAddress, Long relativeAddress, Long length, String kind, String name, String fullyQualifiedName, Long offsetFromParent, Long index, Long parentIndex, PropertyBag properties) {
        super();

...
public class Address {
  ...
  @JsonPropertyDescription(
      "The address expressed as a byte offset from the start of the addressable region.")
  private Long absoluteAddress = -1L;
  ...
  /**
   * @param offsetFromParent The byte offset of this address from the absolute or relative address
   *     of the parent object.
   * @param parentIndex The index within run.addresses of the parent object.
   * @param relativeAddress The address expressed as a byte offset from the absolute address of the
   *     top-most parent object.
   * @param kind An open-ended string that identifies the address kind. 'data', 'function',
   *     'header','instruction', 'module', 'page', 'section', 'segment', 'stack', 'stackFrame',
   *     'table' are well-known values.
   * @param length The number of bytes in this range of addresses.
   * @param name A name that is associated with the address, e.g., '.text'.
   * @param index The index within run.addresses of the cached object for this address.
   * @param fullyQualifiedName A human-readable fully qualified name that is associated with the
   *     address.
   * @param properties Key/value pairs that provide additional information about the address.
   * @param absoluteAddress The address expressed as a byte offset from the start of the addressable
   *     region.
   */
  public Address(
  ...
  /** The address expressed as a byte offset from the start of the addressable region. */
  @JsonProperty("absoluteAddress")
  public void setAbsoluteAddress(Long absoluteAddress) {
    this.absoluteAddress = absoluteAddress;
  }

  public Address withAbsoluteAddress(Long absoluteAddress) {
    this.absoluteAddress = absoluteAddress;
    return this;
  }
   ...
   */
  @JsonProperty("relativeAddress")
  public void setRelativeAddress(Long relativeAddress) {
    this.relativeAddress = relativeAddress;
  }

  public Address withRelativeAddress(Long relativeAddress) {
    this.relativeAddress = relativeAddress;
    return this;
  }
  ...
  public Address withLength(Long length) {
    this.length = length;
    return this;
  }
  ...
  /** The byte offset of this address from the absolute or relative address of the parent object. */
  @JsonProperty("offsetFromParent")
  public Long getOffsetFromParent() {
    return offsetFromParent;
  }

  /** The byte offset of this address from the absolute or relative address of the parent object. */
  @JsonProperty("offsetFromParent")
  public void setOffsetFromParent(Long offsetFromParent) {
    this.offsetFromParent = offsetFromParent;
  }

  public Address withOffsetFromParent(Long offsetFromParent) {
    this.offsetFromParent = offsetFromParent;
    return this;
  }
  ...
  public Address withIndex(Long index) {
    this.index = index;
    return this;
  }
  ...
  public Address withParentIndex(Long parentIndex) {
    this.parentIndex = parentIndex;
    return this;
  }
  ...
  public int hashCode() {
    int result = 1;
    result =
        ((result * 31) + ((this.offsetFromParent == null) ? 0 : this.offsetFromParent.hashCode()));
    result = ((result * 31) + ((this.parentIndex == null) ? 0 : this.parentIndex.hashCode()));
    result =
        ((result * 31) + ((this.relativeAddress == null) ? 0 : this.relativeAddress.hashCode()));
    ...
    result =
        ((result * 31) + ((this.absoluteAddress == null) ? 0 : this.absoluteAddress.hashCode()));
    return result;
  }
  ...
  public boolean equals(Object other) {
    ...
    return (((((((((((this.offsetFromParent == rhs.offsetFromParent)
                                            || ((this.offsetFromParent != null)
                                                && this.offsetFromParent.equals(
                                                    rhs.offsetFromParent)))
                                        && ((this.parentIndex == rhs.parentIndex)
                                            || ((this.parentIndex != null)
                                                && this.parentIndex.equals(rhs.parentIndex))))
                                    && ((this.relativeAddress == rhs.relativeAddress)
                                        || ((this.relativeAddress != null)
                                            && this.relativeAddress.equals(rhs.relativeAddress))))
                                && ((this.kind == rhs.kind)
                ...
                && ((this.fullyQualifiedName == rhs.fullyQualifiedName)
                    || ((this.fullyQualifiedName != null)
                        && this.fullyQualifiedName.equals(rhs.fullyQualifiedName))))
        ...
        && ((this.absoluteAddress == rhs.absoluteAddress)
            || ((this.absoluteAddress != null)
                && this.absoluteAddress.equals(rhs.absoluteAddress))));
  }
}

...
@JsonPropertyOrder({"description", "id", "guid", "correlationGuid", "properties"})
...
public class RunAutomationDetails {
  ...
  /**
   * @param correlationGuid A stable, unique identifier for the equivalence class of runs to which
   *     this object's containing run object belongs in the form of a GUID.
   * @param description A description of the identity and role played within the engineering system
   *     by this object's containing run object.
   * @param guid A stable, unique identifer for this object's containing run object in the form of a
   *     GUID.
   * @param id A hierarchical string that uniquely identifies this object's containing run object.
   * @param properties Key/value pairs that provide additional information about the run automation
   *     details.
   */
  public RunAutomationDetails(
      Message description, String id, String guid, String correlationGuid, PropertyBag properties) {
    super();
  ...
  public String toString() {
    ...
    sb.append(RunAutomationDetails.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((((this.description == rhs.description)
            ...
            && ((this.correlationGuid == rhs.correlationGuid)
                || ((this.correlationGuid != null)
                    && this.correlationGuid.equals(rhs.correlationGuid))))

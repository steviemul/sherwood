...
@JsonPropertyOrder({"id", "label", "sourceNodeId", "targetNodeId", "properties"})
...
public class Edge {
  ...
  /** Identifies the source node (the node at which the edge starts). (Required) */
  @JsonProperty("sourceNodeId")
  @JsonPropertyDescription("Identifies the source node (the node at which the edge starts).")
  private String sourceNodeId;

  /** Identifies the target node (the node at which the edge ends). (Required) */
   ...
   * @param label A short description of the edge.
   * @param targetNodeId Identifies the target node (the node at which the edge ends).
   * @param properties Key/value pairs that provide additional information about the edge.
   */
  public Edge(
      String id, Message label, String sourceNodeId, String targetNodeId, PropertyBag properties) {
    super();
    this.id = id;
    this.label = label;
  ...
  public boolean equals(Object other) {
    ...
    return ((((((this.id == rhs.id) || ((this.id != null) && this.id.equals(rhs.id)))
                    && ((this.label == rhs.label)
                        || ((this.label != null) && this.label.equals(rhs.label))))
                && ((this.targetNodeId == rhs.targetNodeId)
                    || ((this.targetNodeId != null) && this.targetNodeId.equals(rhs.targetNodeId))))
        ...
        && ((this.sourceNodeId == rhs.sourceNodeId)
            || ((this.sourceNodeId != null) && this.sourceNodeId.equals(rhs.sourceNodeId))));
  }
}

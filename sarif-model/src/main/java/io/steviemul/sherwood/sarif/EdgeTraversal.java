...
@JsonPropertyOrder({"edgeId", "message", "finalState", "stepOverEdgeCount", "properties"})
@Generated("jsonschema2pojo")
public class EdgeTraversal {

  /** Identifies the edge being traversed. (Required) */
  @JsonProperty("edgeId")
  ...
  private Long stepOverEdgeCount;
   ...
   * @param stepOverEdgeCount The number of edge traversals necessary to return from a nested graph.
   * @param message A message to display to the user as the edge is traversed.
   * @param finalState The values of relevant expressions after the edge has been traversed.
   * @param properties Key/value pairs that provide additional information about the edge traversal.
   */
  public EdgeTraversal(
      String edgeId,
      Message message,
      FinalState finalState,
      Long stepOverEdgeCount,
  ...
  /** The number of edge traversals necessary to return from a nested graph. */
  @JsonProperty("stepOverEdgeCount")
  public Long getStepOverEdgeCount() {
    return stepOverEdgeCount;
  }

  /** The number of edge traversals necessary to return from a nested graph. */
  @JsonProperty("stepOverEdgeCount")
  public void setStepOverEdgeCount(Long stepOverEdgeCount) {
    this.stepOverEdgeCount = stepOverEdgeCount;
  }

  public EdgeTraversal withStepOverEdgeCount(Long stepOverEdgeCount) {
    this.stepOverEdgeCount = stepOverEdgeCount;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(EdgeTraversal.class.getName())
        .append('@')
  ...
  public int hashCode() {
    ...
    result =
        ((result * 31)
            + ((this.stepOverEdgeCount == null) ? 0 : this.stepOverEdgeCount.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return ((((((this.edgeId == rhs.edgeId)
                ...
                && ((this.stepOverEdgeCount == rhs.stepOverEdgeCount)
                    || ((this.stepOverEdgeCount != null)
                        && this.stepOverEdgeCount.equals(rhs.stepOverEdgeCount))))
            && ((this.finalState == rhs.finalState)
                || ((this.finalState != null) && this.finalState.equals(rhs.finalState))))

...
@JsonPropertyOrder({"uri", "uriBaseId", "index", "description", "properties"})
...
public class ArtifactLocation {
  ...
  /**
   * @param index The index within the run artifacts array of the artifact object associated with
   *     the artifact location.
   * @param description A short description of the artifact location.
   ...
   *     location.
   * @param uriBaseId A string which indirectly specifies the absolute URI with respect to which a
   *     relative URI in the "uri" property is interpreted.
   */
  public ArtifactLocation(
      String uri, String uriBaseId, Long index, Message description, PropertyBag properties) {
    super();
    this.uri = uri;
  ...
  public ArtifactLocation withIndex(Long index) {
    this.index = index;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(ArtifactLocation.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((((this.index == rhs.index) || ((this.index != null) && this.index.equals(rhs.index)))
        ...
        && ((this.uriBaseId == rhs.uriBaseId)
            || ((this.uriBaseId != null) && this.uriBaseId.equals(rhs.uriBaseId))));
  }
}

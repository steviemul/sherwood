...
@JsonPropertyOrder({"message", "frames", "properties"})
...
public class Stack {
   ...
   * order, that comprise the call stack. (Required)
   */
  @JsonProperty("frames")
  ...
  /**
   * @param frames An array of stack frames that represents a sequence of calls, rendered in reverse
   *     chronological order, that comprise the call stack.
   * @param message A message relevant to this call stack.
   * @param properties Key/value pairs that provide additional information about the stack.
   */
  ...
  public boolean equals(Object other) {
    ...
    return ((((this.message == rhs.message)
            ...
            && ((this.frames == rhs.frames)
                || ((this.frames != null) && this.frames.equals(rhs.frames))))

...
@JsonPropertyOrder({"tool", "invocation", "analysisToolLogFiles", "properties"})
...
public class Conversion {
  ...
  /**
   * @param invocation An invocation object that describes the invocation of the converter.
   * @param analysisToolLogFiles The locations of the analysis tool's per-run log files.
   * @param tool A tool object that describes the converter.
   * @param properties Key/value pairs that provide additional information about the conversion.
   */
  public Conversion(
      Tool tool,
      Invocation invocation,
      Set<ArtifactLocation> analysisToolLogFiles,
  ...
  public String toString() {
    ...
    sb.append(Conversion.class.getName())
        .append('@')
  ...
  public int hashCode() {
    ...
    result =
        ((result * 31)
            + ((this.analysisToolLogFiles == null) ? 0 : this.analysisToolLogFiles.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return (((((this.invocation == rhs.invocation)
                    || ((this.invocation != null) && this.invocation.equals(rhs.invocation)))
                && ((this.analysisToolLogFiles == rhs.analysisToolLogFiles)
                    || ((this.analysisToolLogFiles != null)
                        && this.analysisToolLogFiles.equals(rhs.analysisToolLogFiles))))
            && ((this.tool == rhs.tool) || ((this.tool != null) && this.tool.equals(rhs.tool))))

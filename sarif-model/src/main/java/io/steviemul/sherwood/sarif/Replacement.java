...
@JsonPropertyOrder({"deletedRegion", "insertedContent", "properties"})
@Generated("jsonschema2pojo")
public class Replacement {

  /** A region within an artifact where a result was detected. (Required) */
  ...
  /**
   * @param insertedContent The content to insert at the location specified by the 'deletedRegion'
   *     property.
   * @param deletedRegion The region of the artifact to delete.
   * @param properties Key/value pairs that provide additional information about the replacement.
   */
  public Replacement(
      Region deletedRegion, ArtifactContent insertedContent, PropertyBag properties) {
    super();
  ...
  public String toString() {
    ...
    sb.append(Replacement.class.getName())
        .append('@')
  ...
  public int hashCode() {
    int result = 1;
    result =
        ((result * 31) + ((this.insertedContent == null) ? 0 : this.insertedContent.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return ((((this.insertedContent == rhs.insertedContent)
                || ((this.insertedContent != null)
                    && this.insertedContent.equals(rhs.insertedContent)))
            && ((this.deletedRegion == rhs.deletedRegion)
                || ((this.deletedRegion != null) && this.deletedRegion.equals(rhs.deletedRegion))))

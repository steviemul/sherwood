...
@JsonPropertyOrder({"id", "message", "initialState", "immutableState", "locations", "properties"})
...
public class ThreadFlow {
   ...
   * visited by the tool while producing the result. (Required)
   */
  ...
  /**
   * @param initialState Values of relevant expressions at the start of the thread flow that may
   *     change during thread flow execution.
   * @param immutableState Values of relevant expressions at the start of the thread flow that
   *     remain constant.
   * @param locations A temporally ordered array of 'threadFlowLocation' objects, each of which
   *     describes a location visited by the tool while producing the result.
   * @param id An string that uniquely identifies the threadFlow within the codeFlow in which it
   *     occurs.
   * @param message A message relevant to the thread flow.
   * @param properties Key/value pairs that provide additional information about the thread flow.
   */
  public ThreadFlow(
      String id,
      Message message,
  ...
  public String toString() {
    ...
    sb.append(ThreadFlow.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return (((((((this.immutableState == rhs.immutableState)
                ...
                && ((this.initialState == rhs.initialState)
                    || ((this.initialState != null) && this.initialState.equals(rhs.initialState))))

...
@JsonPropertyOrder({"description", "nodes", "edges", "properties"})
...
public class Graph {
  ...
  /**
   * @param nodes An array of node objects representing the nodes of the graph.
   * @param edges An array of edge objects representing the edges of the graph.
  ...
  public boolean equals(Object other) {
    ...
    return (((((this.edges == rhs.edges) || ((this.edges != null) && this.edges.equals(rhs.edges)))
                && ((this.description == rhs.description)
                    || ((this.description != null) && this.description.equals(rhs.description))))
            && ((this.nodes == rhs.nodes)
                || ((this.nodes != null) && this.nodes.equals(rhs.nodes))))

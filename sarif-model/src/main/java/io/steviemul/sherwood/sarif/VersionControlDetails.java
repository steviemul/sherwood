...
public class VersionControlDetails {
  ...
  /** The absolute URI of the repository. (Required) */
  ...
  /**
   * @param revisionId A string that uniquely and permanently identifies the revision within the
   *     repository.
   * @param repositoryUri The absolute URI of the repository.
   * @param mappedTo The location in the local file system to which the root of the repository was
   *     mapped at the time of the analysis.
   * @param branch The name of a branch containing the revision.
   * @param asOfTimeUtc A Coordinated Universal Time (UTC) date and time that can be used to
   *     synchronize an enlistment to the state of the repository at that time.
   * @param properties Key/value pairs that provide additional information about the version control
   *     details.
   * @param revisionTag A tag that has been applied to the revision.
   */
  public VersionControlDetails(
      URI repositoryUri,
      String revisionId,
  ...
  public String toString() {
    ...
    sb.append(VersionControlDetails.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((((((this.revisionId == rhs.revisionId)
                                || ((this.revisionId != null)
                                    && this.revisionId.equals(rhs.revisionId)))
                            && ((this.repositoryUri == rhs.repositoryUri)
                                || ((this.repositoryUri != null)
                                    && this.repositoryUri.equals(rhs.repositoryUri))))
                        && ((this.mappedTo == rhs.mappedTo)
                            || ((this.mappedTo != null) && this.mappedTo.equals(rhs.mappedTo))))
                    && ((this.branch == rhs.branch)
                        || ((this.branch != null) && this.branch.equals(rhs.branch))))
                && ((this.asOfTimeUtc == rhs.asOfTimeUtc)
                    || ((this.asOfTimeUtc != null) && this.asOfTimeUtc.equals(rhs.asOfTimeUtc))))
            && ((this.properties == rhs.properties)
                || ((this.properties != null) && this.properties.equals(rhs.properties))))
        && ((this.revisionTag == rhs.revisionTag)
            || ((this.revisionTag != null) && this.revisionTag.equals(rhs.revisionTag))));
  }
}

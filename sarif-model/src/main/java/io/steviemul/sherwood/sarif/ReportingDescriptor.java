...
public class ReportingDescriptor {
  ...
  /** A stable, opaque identifier for the report. (Required) */
  @JsonProperty("id")
  ...
  @JsonPropertyDescription(
      "An array of objects that describe relationships between this reporting descriptor and others.")
  private Set<ReportingDescriptorRelationship> relationships =
      new LinkedHashSet<ReportingDescriptorRelationship>();
  ...
  /**
   * @param deprecatedIds An array of stable, opaque identifiers by which this report was known in
   *     some previous version of the analysis tool.
   * @param deprecatedGuids An array of unique identifies in the form of a GUID by which this report
   *     was known in some previous version of the analysis tool.
   * @param shortDescription A concise description of the report. Should be a single sentence that
   *     is understandable when visible space is limited to a single line of text.
   * @param fullDescription A description of the report. Should, as far as possible, provide details
   ...
   * @param help Provides the primary documentation for the report, useful when there is no online
   *     documentation.
   * @param relationships An array of objects that describe relationships between this reporting
   *     descriptor and others.
   * @param messageStrings A set of name/value pairs with arbitrary names. Each value is a
   ...
   * @param guid A unique identifer for the reporting descriptor in the form of a GUID.
   * @param deprecatedNames An array of readable identifiers by which this report was known in some
   *     previous version of the analysis tool.
   * @param id A stable, opaque identifier for the report.
   * @param properties Key/value pairs that provide additional information about the report.
   */
  public ReportingDescriptor(
      String id,
      ...
      Set<ReportingDescriptorRelationship> relationships,
  ...
  public String toString() {
    ...
    sb.append(ReportingDescriptor.class.getName())
        .append('@')
  ...
  public int hashCode() {
    ...
    result =
        ((result * 31) + ((this.deprecatedGuids == null) ? 0 : this.deprecatedGuids.hashCode()));
    result =
    ...
    result =
        ((result * 31)
            + ((this.defaultConfiguration == null) ? 0 : this.defaultConfiguration.hashCode()));
    ...
    result =
        ((result * 31) + ((this.deprecatedNames == null) ? 0 : this.deprecatedNames.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return (((((((((((((((this.deprecatedIds == rhs.deprecatedIds)
                                                            || ((this.deprecatedIds != null)
                                                                && this.deprecatedIds.equals(
                                                                    rhs.deprecatedIds)))
                                                        && ((this.deprecatedGuids
                                                                == rhs.deprecatedGuids)
                                                            || ((this.deprecatedGuids != null)
                                                                && this.deprecatedGuids.equals(
                                                                    rhs.deprecatedGuids))))
                                                    && ((this.shortDescription
                                                        ...
                                                        || ((this.shortDescription != null)
                                                            && this.shortDescription.equals(
                                                                rhs.shortDescription))))
                                                && ((this.fullDescription == rhs.fullDescription)
                                                    || ((this.fullDescription != null)
                                                        && this.fullDescription.equals(
                                                            rhs.fullDescription))))
                                            && ((this.helpUri == rhs.helpUri)
                                                || ((this.helpUri != null)
                                                    && this.helpUri.equals(rhs.helpUri))))
                                        && ((this.defaultConfiguration == rhs.defaultConfiguration)
                                            || ((this.defaultConfiguration != null)
                                                && this.defaultConfiguration.equals(
                                                    rhs.defaultConfiguration))))
                                    && ((this.help == rhs.help)
                                        || ((this.help != null) && this.help.equals(rhs.help))))
                                && ((this.relationships == rhs.relationships)
                                    || ((this.relationships != null)
                                        && this.relationships.equals(rhs.relationships))))
                            && ((this.messageStrings == rhs.messageStrings)
                                || ((this.messageStrings != null)
                                    && this.messageStrings.equals(rhs.messageStrings))))
                        && ((this.name == rhs.name)
                            || ((this.name != null) && this.name.equals(rhs.name))))
                    && ((this.guid == rhs.guid)
                        || ((this.guid != null) && this.guid.equals(rhs.guid))))
                && ((this.deprecatedNames == rhs.deprecatedNames)
                    || ((this.deprecatedNames != null)
                        && this.deprecatedNames.equals(rhs.deprecatedNames))))

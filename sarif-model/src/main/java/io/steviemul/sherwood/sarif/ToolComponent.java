...
public class ToolComponent {
  ...
  /** The name of the tool component. (Required) */
  @JsonProperty("name")
  ...
  private Set<Content> contents =
      new LinkedHashSet<Content>(
          Arrays.asList(Content.fromValue("localizedData"), Content.fromValue("nonLocalizedData")));
  ...
  private Set<ToolComponentReference> supportedTaxonomies =
      new LinkedHashSet<ToolComponentReference>();
  ...
  /**
   * @param releaseDateUtc A string specifying the UTC date (and optionally, the time) of the
   *     component's release.
   * @param rules An array of reportingDescriptor objects relevant to the analysis performed by the
   *     tool component.
   * @param language The language of the messages emitted into the log file during this run
   *     (expressed as an ISO 639-1 two-letter lowercase language code) and an optional region
   *     (expressed as an ISO 3166-1 two-letter uppercase subculture code associated with a country
   *     or region). The casing is recommended but not required (in order for this data to conform
   *     to RFC5646).
   * @param downloadUri The absolute URI from which the tool component can be downloaded.
   * @param supportedTaxonomies An array of toolComponentReference objects to declare the taxonomies
   *     supported by the tool component.
   * @param fullDescription A comprehensive description of the tool component.
   * @param informationUri The absolute URI at which information about this version of the tool
   *     component can be found.
   * @param associatedComponent The component which is strongly associated with this component. For
   *     a translation, this refers to the component which has been translated. For an extension,
   *     this is the driver that provides the extension's plugin model.
   * @param translationMetadata Translation metadata, required for a translation, not populated by
   *     other component types.
   * @param productSuite A localizable string containing the name of the suite of products to which
   *     the tool component belongs.
   * @param taxa An array of reportingDescriptor objects relevant to the definitions of both
   *     standalone and tool-defined taxonomies.
   * @param product A product suite to which the tool component belongs.
   * @param isComprehensive Specifies whether this object contains a complete definition of the
   *     localizable and/or non-localizable data for this component, as opposed to including only
   *     data that is relevant to the results persisted to this log file.
   * @param minimumRequiredLocalizedDataSemanticVersion The minimum value of
   *     localizedDataSemanticVersion required in translations consumed by this component; used by
   *     components that consume translations.
   * @param fullName The name of the tool component along with its version and any other useful
   *     identifying information, such as its locale.
   * @param shortDescription A brief description of the tool component.
   * @param version The tool component version, in whatever format the component natively provides.
   * @param globalMessageStrings A dictionary, each of whose keys is a resource identifier and each
   *     of whose values is a multiformatMessageString object, which holds message strings in plain
   *     text and (optionally) Markdown format. The strings can include placeholders, which can be
   *     used to construct a message in combination with an arbitrary number of additional string
   *     arguments.
   * @param localizedDataSemanticVersion The semantic version of the localized strings defined in
   *     this component; maintained by components that provide translations.
   * @param dottedQuadFileVersion The binary version of the tool component's primary executable file
   *     expressed as four non-negative integers separated by a period (for operating systems that
   *     express file versions in this way).
   * @param contents The kinds of data contained in this object.
   * @param organization The organization or company that produced the tool component.
   * @param name The name of the tool component.
   * @param semanticVersion The tool component version in the format specified by Semantic
   *     Versioning 2.0.
   * @param guid A unique identifer for the tool component in the form of a GUID.
   * @param locations An array of the artifactLocation objects associated with the tool component.
   * @param notifications An array of reportingDescriptor objects relevant to the notifications
   *     related to the configuration and runtime execution of the tool component.
   * @param properties Key/value pairs that provide additional information about the tool component.
   */
  public ToolComponent(
      String guid,
      String name,
      ...
      Set<ReportingDescriptor> notifications,
      Set<ReportingDescriptor> rules,
      Set<ReportingDescriptor> taxa,
      ...
      Set<ToolComponentReference> supportedTaxonomies,
   ...
   */
  @JsonProperty("minimumRequiredLocalizedDataSemanticVersion")
  public void setMinimumRequiredLocalizedDataSemanticVersion(
      String minimumRequiredLocalizedDataSemanticVersion) {
    this.minimumRequiredLocalizedDataSemanticVersion = minimumRequiredLocalizedDataSemanticVersion;
  }

  public ToolComponent withMinimumRequiredLocalizedDataSemanticVersion(
      String minimumRequiredLocalizedDataSemanticVersion) {
    this.minimumRequiredLocalizedDataSemanticVersion = minimumRequiredLocalizedDataSemanticVersion;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(ToolComponent.class.getName())
        .append('@')
    ...
    sb.append('=');
    sb.append(
        ((this.localizedDataSemanticVersion == null)
            ? "<null>"
            : this.localizedDataSemanticVersion));
    sb.append(',');
    sb.append("minimumRequiredLocalizedDataSemanticVersion");
    sb.append('=');
    sb.append(
        ((this.minimumRequiredLocalizedDataSemanticVersion == null)
            ? "<null>"
  ...
  public int hashCode() {
    ...
    result =
        ((result * 31)
            + ((this.supportedTaxonomies == null) ? 0 : this.supportedTaxonomies.hashCode()));
    result =
        ((result * 31) + ((this.fullDescription == null) ? 0 : this.fullDescription.hashCode()));
    result = ((result * 31) + ((this.informationUri == null) ? 0 : this.informationUri.hashCode()));
    result =
        ((result * 31)
            + ((this.associatedComponent == null) ? 0 : this.associatedComponent.hashCode()));
    result =
        ((result * 31)
            + ((this.translationMetadata == null) ? 0 : this.translationMetadata.hashCode()));
    ...
    result =
        ((result * 31) + ((this.isComprehensive == null) ? 0 : this.isComprehensive.hashCode()));
    result =
        ((result * 31)
            + ((this.minimumRequiredLocalizedDataSemanticVersion == null)
                ? 0
                : this.minimumRequiredLocalizedDataSemanticVersion.hashCode()));
    result = ((result * 31) + ((this.fullName == null) ? 0 : this.fullName.hashCode()));
    result =
        ((result * 31) + ((this.shortDescription == null) ? 0 : this.shortDescription.hashCode()));
    result = ((result * 31) + ((this.version == null) ? 0 : this.version.hashCode()));
    result =
        ((result * 31)
            + ((this.globalMessageStrings == null) ? 0 : this.globalMessageStrings.hashCode()));
    result =
        ((result * 31)
            + ((this.localizedDataSemanticVersion == null)
                ? 0
                : this.localizedDataSemanticVersion.hashCode()));
    result =
        ((result * 31)
            + ((this.dottedQuadFileVersion == null) ? 0 : this.dottedQuadFileVersion.hashCode()));
    ...
    result =
        ((result * 31) + ((this.semanticVersion == null) ? 0 : this.semanticVersion.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return (((((((((((((((((((((((((((((this.releaseDateUtc == rhs.releaseDateUtc)
                                                                                                                    || ((this
                                                                                                                                .releaseDateUtc
                                                                                                                            != null)
                                                                                                                        && this
                                                                ...
                                                                && ((this
                                                                            .minimumRequiredLocalizedDataSemanticVersion
                                                                        == rhs.minimumRequiredLocalizedDataSemanticVersion)
                                                                    || ((this
                                                                                .minimumRequiredLocalizedDataSemanticVersion
                                                                            != null)
                                                                        && this
                                                        ...
                                                        && ((this.shortDescription
                                                            ...
                                                            || ((this.shortDescription != null)
                                                                && this.shortDescription.equals(
                                                                    rhs.shortDescription))))
                                                    && ((this.version == rhs.version)
                                                        || ((this.version != null)
                                                            && this.version.equals(rhs.version))))
                                                && ((this.globalMessageStrings
                                                        == rhs.globalMessageStrings)
                                                    || ((this.globalMessageStrings != null)
                                                        && this.globalMessageStrings.equals(
                                                            rhs.globalMessageStrings))))
                                            && ((this.localizedDataSemanticVersion
                                                    == rhs.localizedDataSemanticVersion)
                                                || ((this.localizedDataSemanticVersion != null)
                                                    && this.localizedDataSemanticVersion.equals(
                                                        rhs.localizedDataSemanticVersion))))
                                        && ((this.dottedQuadFileVersion
                                                == rhs.dottedQuadFileVersion)
                                            || ((this.dottedQuadFileVersion != null)
                                                && this.dottedQuadFileVersion.equals(
                                                    rhs.dottedQuadFileVersion))))
                                    && ((this.contents == rhs.contents)
                                        || ((this.contents != null)
                                            && this.contents.equals(rhs.contents))))
                                && ((this.organization == rhs.organization)
                                    || ((this.organization != null)
                                        && this.organization.equals(rhs.organization))))
                            && ((this.name == rhs.name)
                                || ((this.name != null) && this.name.equals(rhs.name))))
                        && ((this.semanticVersion == rhs.semanticVersion)
                            || ((this.semanticVersion != null)
                                && this.semanticVersion.equals(rhs.semanticVersion))))
                    && ((this.guid == rhs.guid)
                        || ((this.guid != null) && this.guid.equals(rhs.guid))))
                && ((this.locations == rhs.locations)
                    || ((this.locations != null) && this.locations.equals(rhs.locations))))
            && ((this.notifications == rhs.notifications)
                || ((this.notifications != null) && this.notifications.equals(rhs.notifications))))

...
public class Invocation {
     ...
     *     The name of the signal that caused the process to exit.
     */
    public Invocation(String commandLine, List<String> arguments, Set<ArtifactLocation> responseFiles, Date startTimeUtc, Date endTimeUtc, Long exitCode, Set<ConfigurationOverride> ruleConfigurationOverrides, Set<ConfigurationOverride> notificationConfigurationOverrides, List<Notification> toolExecutionNotifications, List<Notification> toolConfigurationNotifications, String exitCodeDescription, String exitSignalName, Long exitSignalNumber, String processStartFailureMessage, Boolean executionSuccessful, String machine, String account, Long processId, ArtifactLocation executableLocation, ArtifactLocation workingDirectory, EnvironmentVariables environmentVariables, ArtifactLocation stdin, ArtifactLocation stdout, ArtifactLocation stderr, ArtifactLocation stdoutStderr, PropertyBag properties) {
        super();

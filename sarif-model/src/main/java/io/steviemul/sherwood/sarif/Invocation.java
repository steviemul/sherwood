...
public class Invocation {
  ...
  @JsonPropertyDescription(
      "An array of configurationOverride objects that describe rules related runtime overrides.")
  private Set<ConfigurationOverride> ruleConfigurationOverrides =
      new LinkedHashSet<ConfigurationOverride>();
  ...
  private Set<ConfigurationOverride> notificationConfigurationOverrides =
      new LinkedHashSet<ConfigurationOverride>();
  ...
  /** Specifies whether the tool's execution completed successfully. (Required) */
  ...
  /**
   * @param endTimeUtc The Coordinated Universal Time (UTC) date and time at which the run ended.
   *     See "Date/time properties" in the SARIF spec for the required format.
   * @param stdin A file containing the standard input stream to the process that was invoked.
   * @param stdout A file containing the standard output stream from the process that was invoked.
   * @param workingDirectory The working directory for the analysis tool run.
   * @param exitSignalNumber The numeric value of the signal that caused the process to exit.
   * @param exitCodeDescription The reason for the process exit.
   * @param executableLocation An absolute URI specifying the location of the analysis tool's
   *     executable.
   * @param processId The process id for the analysis tool run.
   * @param exitCode The process exit code.
   * @param toolConfigurationNotifications A list of conditions detected by the tool that are
   *     relevant to the tool's configuration.
   * @param notificationConfigurationOverrides An array of configurationOverride objects that
   *     describe notifications related runtime overrides.
   * @param processStartFailureMessage The reason given by the operating system that the process
   *     failed to start.
   * @param stderr A file containing the standard error stream from the process that was invoked.
   * @param ruleConfigurationOverrides An array of configurationOverride objects that describe rules
   *     related runtime overrides.
   * @param toolExecutionNotifications A list of runtime conditions detected by the tool during the
   *     analysis.
   * @param machine The machine that hosted the analysis tool run.
   * @param environmentVariables The environment variables associated with the analysis tool
   *     process, expressed as key/value pairs.
   * @param stdoutStderr A file containing the interleaved standard output and standard error stream
   *     from the process that was invoked.
   * @param arguments An array of strings, containing in order the command line arguments passed to
   *     the tool from the operating system.
   * @param responseFiles The locations of any response files specified on the tool's command line.
   * @param commandLine The command line used to invoke the tool.
   * @param executionSuccessful Specifies whether the tool's execution completed successfully.
   * @param startTimeUtc The Coordinated Universal Time (UTC) date and time at which the run
   *     started. See "Date/time properties" in the SARIF spec for the required format.
   * @param account The account that ran the analysis tool.
   * @param properties Key/value pairs that provide additional information about the invocation.
   * @param exitSignalName The name of the signal that caused the process to exit.
   */
  public Invocation(
      String commandLine,
      List<String> arguments,
      Set<ArtifactLocation> responseFiles,
      Date startTimeUtc,
      Date endTimeUtc,
      Long exitCode,
      Set<ConfigurationOverride> ruleConfigurationOverrides,
  ...
  public Invocation withRuleConfigurationOverrides(
      Set<ConfigurationOverride> ruleConfigurationOverrides) {
    this.ruleConfigurationOverrides = ruleConfigurationOverrides;
    return this;
  }
   ...
   */
  @JsonProperty("notificationConfigurationOverrides")
  public void setNotificationConfigurationOverrides(
      Set<ConfigurationOverride> notificationConfigurationOverrides) {
    this.notificationConfigurationOverrides = notificationConfigurationOverrides;
  }

  public Invocation withNotificationConfigurationOverrides(
      Set<ConfigurationOverride> notificationConfigurationOverrides) {
    this.notificationConfigurationOverrides = notificationConfigurationOverrides;
    return this;
  }
  ...
  public Invocation withToolConfigurationNotifications(
      List<Notification> toolConfigurationNotifications) {
    this.toolConfigurationNotifications = toolConfigurationNotifications;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(Invocation.class.getName())
        .append('@')
    ...
    sb.append('=');
    sb.append(
        ((this.ruleConfigurationOverrides == null) ? "<null>" : this.ruleConfigurationOverrides));
    sb.append(',');
    ...
    sb.append(
        ((this.notificationConfigurationOverrides == null)
            ? "<null>"
            : this.notificationConfigurationOverrides));
    sb.append(',');
    sb.append("toolExecutionNotifications");
    sb.append('=');
    sb.append(
        ((this.toolExecutionNotifications == null) ? "<null>" : this.toolExecutionNotifications));
    sb.append(',');
    ...
    sb.append('=');
    sb.append(
        ((this.processStartFailureMessage == null) ? "<null>" : this.processStartFailureMessage));
    sb.append(',');
  ...
  public int hashCode() {
    ...
    result =
        ((result * 31) + ((this.workingDirectory == null) ? 0 : this.workingDirectory.hashCode()));
    result =
        ((result * 31) + ((this.exitSignalNumber == null) ? 0 : this.exitSignalNumber.hashCode()));
    result =
        ((result * 31)
            + ((this.exitCodeDescription == null) ? 0 : this.exitCodeDescription.hashCode()));
    result =
        ((result * 31)
            + ((this.executableLocation == null) ? 0 : this.executableLocation.hashCode()));
    ...
    result =
        ((result * 31)
            + ((this.toolConfigurationNotifications == null)
                ? 0
                : this.toolConfigurationNotifications.hashCode()));
    result =
        ((result * 31)
            + ((this.notificationConfigurationOverrides == null)
                ? 0
                : this.notificationConfigurationOverrides.hashCode()));
    result =
        ((result * 31)
            + ((this.processStartFailureMessage == null)
                ? 0
                : this.processStartFailureMessage.hashCode()));
    result = ((result * 31) + ((this.stderr == null) ? 0 : this.stderr.hashCode()));
    result =
        ((result * 31)
            + ((this.ruleConfigurationOverrides == null)
                ? 0
                : this.ruleConfigurationOverrides.hashCode()));
    result =
        ((result * 31)
            + ((this.toolExecutionNotifications == null)
                ? 0
                : this.toolExecutionNotifications.hashCode()));
    ...
    result =
        ((result * 31)
            + ((this.executionSuccessful == null) ? 0 : this.executionSuccessful.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return (((((((((((((((((((((((((((this.endTimeUtc == rhs.endTimeUtc)
                                                                                                            || ((this
                                                                                                                        .endTimeUtc
                                                                                                                    != null)
                                                                                                                && this
                                                                        ...
                                                                        && ((this
                                                                                    .toolConfigurationNotifications
                                                                                == rhs.toolConfigurationNotifications)
                                                                            || ((this
                                                                                        .toolConfigurationNotifications
                                                                                    != null)
                                                                                && this
                                                                    ...
                                                                    && ((this
                                                                                .notificationConfigurationOverrides
                                                                            == rhs.notificationConfigurationOverrides)
                                                                        || ((this
                                                                                    .notificationConfigurationOverrides
                                                                                != null)
                                                                            && this
                                                                                ...
                                                                                .equals(
                                                                                    rhs.notificationConfigurationOverrides))))
                                                                && ((this.processStartFailureMessage
                                                                        == rhs.processStartFailureMessage)
                                                                    || ((this
                                                                                .processStartFailureMessage
                                                                            != null)
                                                                        && this
                                                                            ...
                                                                            .equals(
                                                                                rhs.processStartFailureMessage))))
                                                            && ((this.stderr == rhs.stderr)
                                                                || ((this.stderr != null)
                                                                    && this.stderr.equals(
                                                                        rhs.stderr))))
                                                        && ((this.ruleConfigurationOverrides
                                                                == rhs.ruleConfigurationOverrides)
                                                            || ((this.ruleConfigurationOverrides
                                                                    != null)
                                                                && this.ruleConfigurationOverrides
                                                                    .equals(
                                                    ...
                                                    && ((this.toolExecutionNotifications
                                                            == rhs.toolExecutionNotifications)
                                                        || ((this.toolExecutionNotifications
                                                                != null)
                                                            && this.toolExecutionNotifications
                                                                .equals(
                                                ...
                                                && ((this.machine == rhs.machine)
                                                    || ((this.machine != null)
                                                        && this.machine.equals(rhs.machine))))
                                            && ((this.environmentVariables
                                                    == rhs.environmentVariables)
                                                || ((this.environmentVariables != null)
                                                    && this.environmentVariables.equals(
                                                        rhs.environmentVariables))))
                                        && ((this.stdoutStderr == rhs.stdoutStderr)
                                            || ((this.stdoutStderr != null)
                                                && this.stdoutStderr.equals(rhs.stdoutStderr))))
                                    && ((this.arguments == rhs.arguments)
                                        || ((this.arguments != null)
                                            && this.arguments.equals(rhs.arguments))))
                                && ((this.responseFiles == rhs.responseFiles)
                                    || ((this.responseFiles != null)
                                        && this.responseFiles.equals(rhs.responseFiles))))
                            && ((this.commandLine == rhs.commandLine)
                                || ((this.commandLine != null)
                                    && this.commandLine.equals(rhs.commandLine))))
                        && ((this.executionSuccessful == rhs.executionSuccessful)
                            || ((this.executionSuccessful != null)
                                && this.executionSuccessful.equals(rhs.executionSuccessful))))
                    && ((this.startTimeUtc == rhs.startTimeUtc)
                        || ((this.startTimeUtc != null)
                            && this.startTimeUtc.equals(rhs.startTimeUtc))))
                && ((this.account == rhs.account)
                    || ((this.account != null) && this.account.equals(rhs.account))))
            && ((this.properties == rhs.properties)
                || ((this.properties != null) && this.properties.equals(rhs.properties))))
        && ((this.exitSignalName == rhs.exitSignalName)
            || ((this.exitSignalName != null) && this.exitSignalName.equals(rhs.exitSignalName))));
  }
}

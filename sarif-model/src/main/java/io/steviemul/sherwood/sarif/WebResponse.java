...
public class WebResponse {
   ...
   * @param protocol The response protocol. Example: 'http'.
   * @param reasonPhrase The response reason. Example: 'Not found'.
   * @param noResponseReceived Specifies whether a response was received from the server.
   * @param index The index within the run.webResponses array of the response object associated with
   *     this result.
   * @param body The body of the response.
   * @param version The response version. Example: '1.1'.
   * @param properties Key/value pairs that provide additional information about the response.
   * @param statusCode The response status code. Example: 451.
   */
  public WebResponse(
      Long index,
      String protocol,
  ...
  public WebResponse withIndex(Long index) {
    this.index = index;
    return this;
  }
  ...
  public WebResponse withStatusCode(Long statusCode) {
    this.statusCode = statusCode;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(WebResponse.class.getName())
        .append('@')
  ...
  public int hashCode() {
    ...
    result =
        ((result * 31)
            + ((this.noResponseReceived == null) ? 0 : this.noResponseReceived.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return ((((((((((this.headers == rhs.headers)
                                ...
                                && ((this.reasonPhrase == rhs.reasonPhrase)
                                    || ((this.reasonPhrase != null)
                                        && this.reasonPhrase.equals(rhs.reasonPhrase))))
                            && ((this.noResponseReceived == rhs.noResponseReceived)
                                || ((this.noResponseReceived != null)
                                    && this.noResponseReceived.equals(rhs.noResponseReceived))))
                        && ((this.index == rhs.index)
                            || ((this.index != null) && this.index.equals(rhs.index))))
                    && ((this.body == rhs.body)
                        || ((this.body != null) && this.body.equals(rhs.body))))

...
public class WebResponse {
     ...
     *     The response status code. Example: 451.
     */
    public WebResponse(Long index, String protocol, String version, Long statusCode, String reasonPhrase, Headers__1 headers, ArtifactContent body, Boolean noResponseReceived, PropertyBag properties) {
        super();
        this.index = index;

...
public class TranslationMetadata {
   ...
   * @param fullName The full name associated with the translation metadata.
   * @param shortDescription A brief description of the translation metadata.
   * @param downloadUri The absolute URI from which the translation metadata can be downloaded.
   * @param fullDescription A comprehensive description of the translation metadata.
   * @param informationUri The absolute URI from which information related to the translation
   *     metadata can be downloaded.
   * @param properties Key/value pairs that provide additional information about the translation
   *     metadata.
   */
  public TranslationMetadata(
      String name,
  ...
  public String toString() {
    ...
    sb.append(TranslationMetadata.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((((((this.name == rhs.name) || ((this.name != null) && this.name.equals(rhs.name)))
                            && ((this.fullName == rhs.fullName)
                                || ((this.fullName != null) && this.fullName.equals(rhs.fullName))))
                        && ((this.shortDescription == rhs.shortDescription)
                            || ((this.shortDescription != null)
                                && this.shortDescription.equals(rhs.shortDescription))))
                    && ((this.downloadUri == rhs.downloadUri)
                        || ((this.downloadUri != null)
                            && this.downloadUri.equals(rhs.downloadUri))))
                && ((this.fullDescription == rhs.fullDescription)
                    || ((this.fullDescription != null)
                        && this.fullDescription.equals(rhs.fullDescription))))
            && ((this.informationUri == rhs.informationUri)
                || ((this.informationUri != null)
                    && this.informationUri.equals(rhs.informationUri))))

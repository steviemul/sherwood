...
public class Message {
  ...
  /**
   * @param markdown A Markdown message string.
   * @param arguments An array of strings to substitute into the message string.
   ...
   */
  public Message(
      String text, String markdown, String id, List<String> arguments, PropertyBag properties) {
    super();
    this.text = text;

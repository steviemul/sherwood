...
@JsonPropertyOrder({"top", "left", "bottom", "right", "message", "properties"})
...
public class Rectangle {
   ...
   *     units.
   * @param left The X coordinate of the left edge of the rectangle, measured in the image's natural
   *     units.
   ...
   *     natural units.
   * @param message A message relevant to the rectangle.
   * @param properties Key/value pairs that provide additional information about the rectangle.
   */
  public Rectangle(
      Double top,
      Double left,
  ...
  public boolean equals(Object other) {
    ...
    return (((((((this.right == rhs.right)
                            || ((this.right != null) && this.right.equals(rhs.right)))
                        && ((this.top == rhs.top)
                            || ((this.top != null) && this.top.equals(rhs.top))))
                    && ((this.message == rhs.message)
                        || ((this.message != null) && this.message.equals(rhs.message))))
                && ((this.left == rhs.left) || ((this.left != null) && this.left.equals(rhs.left))))
            && ((this.bottom == rhs.bottom)
                || ((this.bottom != null) && this.bottom.equals(rhs.bottom))))

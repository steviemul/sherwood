...
public class ArtifactContent {
  ...
  /**
   * @param rendered An alternate rendered representation of the artifact (e.g., a decompiled
   *     representation of a binary region).
   * @param binary MIME Base64-encoded content from a binary artifact, or from a text artifact in
   *     its original encoding.
   * @param text UTF-8-encoded content from a text artifact.
   * @param properties Key/value pairs that provide additional information about the artifact
   *     content.
   */
  public ArtifactContent(
      String text, String binary, MultiformatMessageString rendered, PropertyBag properties) {
    super();
    this.text = text;
    this.binary = binary;
  ...
  public String toString() {
    ...
    sb.append(ArtifactContent.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return (((((this.text == rhs.text) || ((this.text != null) && this.text.equals(rhs.text)))
                && ((this.rendered == rhs.rendered)
                    || ((this.rendered != null) && this.rendered.equals(rhs.rendered))))
            && ((this.properties == rhs.properties)
                || ((this.properties != null) && this.properties.equals(rhs.properties))))
        && ((this.binary == rhs.binary)
            || ((this.binary != null) && this.binary.equals(rhs.binary))));
  }
}

...
/**
 * The artifact location specified by each uriBaseId symbol on the machine where the tool originally
 * ran.
 */
...
public class OriginalUriBaseIds {
  ...
  @JsonIgnore
  private Map<String, ArtifactLocation> additionalProperties =
      new LinkedHashMap<String, ArtifactLocation>();
  ...
  public String toString() {
    ...
    sb.append(OriginalUriBaseIds.class.getName())
        .append('@')

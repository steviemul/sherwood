...
@JsonPropertyOrder({"configuration", "descriptor", "properties"})
@Generated("jsonschema2pojo")
public class ConfigurationOverride {

  /** Information about a rule or notification that can be configured at runtime. (Required) */
  ...
  /**
   * @param configuration Specifies how the rule or notification was configured during the scan.
   * @param descriptor A reference used to locate the descriptor whose configuration was overridden.
   * @param properties Key/value pairs that provide additional information about the configuration
   *     override.
   */
  public ConfigurationOverride(
  ...
  public String toString() {
    ...
    sb.append(ConfigurationOverride.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((this.configuration == rhs.configuration)
                || ((this.configuration != null) && this.configuration.equals(rhs.configuration)))

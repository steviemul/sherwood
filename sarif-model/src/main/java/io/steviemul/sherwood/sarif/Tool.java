...
public class Tool {
  ...
  /** A component, such as a plug-in or the driver, of the analysis tool that was run. (Required) */
  @JsonProperty("driver")
  ...
  /**
   * @param extensions Tool extensions that contributed to or reconfigured the analysis tool that
   *     was run.
   * @param driver The analysis tool that was run.
   * @param properties Key/value pairs that provide additional information about the tool.
   */
  ...
  public boolean equals(Object other) {
    ...
    return ((((this.driver == rhs.driver)
                || ((this.driver != null) && this.driver.equals(rhs.driver)))

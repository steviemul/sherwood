...
public class GraphTraversal {
  ...
  private Long resultGraphIndex = -1L;
  ...
  /**
   * @param initialState Values of relevant expressions at the start of the graph traversal that may
   *     change during graph traversal.
   * @param description A description of this graph traversal.
   * @param immutableState Values of relevant expressions at the start of the graph traversal that
   *     remain constant for the graph traversal.
   * @param runGraphIndex The index within the run.graphs to be associated with the result.
   * @param resultGraphIndex The index within the result.graphs to be associated with the result.
   * @param edgeTraversals The sequences of edges traversed by this graph traversal.
   * @param properties Key/value pairs that provide additional information about the graph
   *     traversal.
   */
  public GraphTraversal(
      Long runGraphIndex,
      Long resultGraphIndex,
      Message description,
      InitialState__1 initialState,
      ImmutableState__1 immutableState,
      List<EdgeTraversal> edgeTraversals,
  ...
  /** The index within the run.graphs to be associated with the result. */
  @JsonProperty("runGraphIndex")
  public Long getRunGraphIndex() {
    return runGraphIndex;
  }

  /** The index within the run.graphs to be associated with the result. */
  @JsonProperty("runGraphIndex")
  public void setRunGraphIndex(Long runGraphIndex) {
    this.runGraphIndex = runGraphIndex;
  }

  public GraphTraversal withRunGraphIndex(Long runGraphIndex) {
    this.runGraphIndex = runGraphIndex;
    return this;
  }
  ...
  /** The index within the result.graphs to be associated with the result. */
  @JsonProperty("resultGraphIndex")
  public Long getResultGraphIndex() {
    return resultGraphIndex;
  }

  /** The index within the result.graphs to be associated with the result. */
  @JsonProperty("resultGraphIndex")
  public void setResultGraphIndex(Long resultGraphIndex) {
    this.resultGraphIndex = resultGraphIndex;
  }

  public GraphTraversal withResultGraphIndex(Long resultGraphIndex) {
    this.resultGraphIndex = resultGraphIndex;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(GraphTraversal.class.getName())
        .append('@')
  ...
  public int hashCode() {
    ...
    result =
        ((result * 31) + ((this.resultGraphIndex == null) ? 0 : this.resultGraphIndex.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return ((((((((this.initialState == rhs.initialState)
                                || ((this.initialState != null)
                                    && this.initialState.equals(rhs.initialState)))
                            && ((this.description == rhs.description)
                                || ((this.description != null)
                                    && this.description.equals(rhs.description))))
                        && ((this.immutableState == rhs.immutableState)
                            || ((this.immutableState != null)
                                && this.immutableState.equals(rhs.immutableState))))
                    && ((this.runGraphIndex == rhs.runGraphIndex)
                        || ((this.runGraphIndex != null)
                            && this.runGraphIndex.equals(rhs.runGraphIndex))))
                && ((this.resultGraphIndex == rhs.resultGraphIndex)
                    || ((this.resultGraphIndex != null)
                        && this.resultGraphIndex.equals(rhs.resultGraphIndex))))
            && ((this.edgeTraversals == rhs.edgeTraversals)
                || ((this.edgeTraversals != null)
                    && this.edgeTraversals.equals(rhs.edgeTraversals))))

...
public class GraphTraversal {
     ...
     */
    public GraphTraversal(Long runGraphIndex, Long resultGraphIndex, Message description, InitialState__1 initialState, ImmutableState__1 immutableState, List<EdgeTraversal> edgeTraversals, PropertyBag properties) {
        super();

...
public class LogicalLocation {
  ...
  /**
   * @param parentIndex Identifies the index of the immediate parent of the construct in which the
   *     result was detected. For example, this property might point to a logical location that
   *     represents the namespace that holds a type.
   * @param kind The type of construct this logical location component refers to. Should be one of
   ...
   * @param name Identifies the construct in which the result occurred. For example, this property
   *     might contain the name of a class or a method.
   * @param index The index within the logical locations array.
   * @param decoratedName The machine-readable name for the logical location, such as a mangled
   *     function name provided by a C++ compiler that encodes calling convention, return type and
   *     other details along with the function name.
   * @param fullyQualifiedName The human-readable fully qualified name of the logical location.
   * @param properties Key/value pairs that provide additional information about the logical
   *     location.
   */
  public LogicalLocation(
      String name,
  ...
  public LogicalLocation withIndex(Long index) {
    this.index = index;
    return this;
  }
  ...
  public LogicalLocation withParentIndex(Long parentIndex) {
    this.parentIndex = parentIndex;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(LogicalLocation.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((((((this.parentIndex == rhs.parentIndex)
                ...
                && ((this.decoratedName == rhs.decoratedName)
                    || ((this.decoratedName != null)
                        && this.decoratedName.equals(rhs.decoratedName))))

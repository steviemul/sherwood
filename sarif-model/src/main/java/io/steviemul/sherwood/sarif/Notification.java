...
public class Notification {
  ...
  /**
   * @param threadId The thread identifier of the code that generated the notification.
   * @param exception The runtime exception, if any, relevant to this notification.
   * @param level A value specifying the severity level of the notification.
   * @param associatedRule A reference used to locate the rule descriptor associated with this
   *     notification.
   * @param timeUtc The Coordinated Universal Time (UTC) date and time at which the analysis tool
   *     generated the notification.
   * @param locations The locations relevant to this notification.
   * @param descriptor A reference used to locate the descriptor relevant to this notification.
   * @param message A message that describes the condition that was encountered.
   * @param properties Key/value pairs that provide additional information about the notification.
   */
  public Notification(
  ...
  public Notification withThreadId(Long threadId) {
    this.threadId = threadId;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(Notification.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((((((((this.threadId == rhs.threadId)
                                        || ((this.threadId != null)
                                            && this.threadId.equals(rhs.threadId)))
                                    && ((this.exception == rhs.exception)
                                        || ((this.exception != null)
                                            && this.exception.equals(rhs.exception))))
                                && ((this.level == rhs.level)
                                    || ((this.level != null) && this.level.equals(rhs.level))))
                            && ((this.associatedRule == rhs.associatedRule)
                                || ((this.associatedRule != null)
                                    && this.associatedRule.equals(rhs.associatedRule))))
                        && ((this.timeUtc == rhs.timeUtc)
                            || ((this.timeUtc != null) && this.timeUtc.equals(rhs.timeUtc))))
                    && ((this.locations == rhs.locations)
                        || ((this.locations != null) && this.locations.equals(rhs.locations))))
                && ((this.descriptor == rhs.descriptor)
                    || ((this.descriptor != null) && this.descriptor.equals(rhs.descriptor))))
  ...
  public enum Level {
    ...
    private static final Map<String, Notification.Level> CONSTANTS =
        new HashMap<String, Notification.Level>();

...
public class Notification {
     ...
     */
    public Notification(Set<Location> locations, Message message, Notification.Level level, Long threadId, Date timeUtc, Exception exception, ReportingDescriptorReference descriptor, ReportingDescriptorReference associatedRule, PropertyBag properties) {
        super();

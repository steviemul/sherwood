...
public class Artifact {
     ...
     */
    public Artifact(Message description, ArtifactLocation location, Long parentIndex, Long offset, Long length, Set<Role> roles, String mimeType, ArtifactContent contents, String encoding, String sourceLanguage, Hashes hashes, Date lastModifiedTimeUtc, PropertyBag properties) {
        super();

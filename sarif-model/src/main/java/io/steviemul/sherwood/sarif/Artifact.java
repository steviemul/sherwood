...
public class Artifact {
  ...
  /**
   * @param parentIndex Identifies the index of the immediate parent of the artifact, if this
   *     artifact is nested.
   * @param offset The offset in bytes of the artifact within its containing artifact.
   * @param roles The role or roles played by the artifact in the analysis.
   * @param lastModifiedTimeUtc The Coordinated Universal Time (UTC) date and time at which the
   *     artifact was most recently modified. See "Date/time properties" in the SARIF spec for the
   *     required format.
   * @param length The length of the artifact in bytes.
   * @param description A short description of the artifact.
   * @param mimeType The MIME type (RFC 2045) of the artifact.
   * @param encoding Specifies the encoding for an artifact object that refers to a text file.
   * @param contents The contents of the artifact.
   * @param hashes A dictionary, each of whose keys is the name of a hash function and each of whose
   ...
   * @param sourceLanguage Specifies the source language for any artifact object that refers to a
   *     text file that contains source code.
   * @param properties Key/value pairs that provide additional information about the artifact.
   */
  public Artifact(
      Message description,
  ...
  public Artifact withParentIndex(Long parentIndex) {
    this.parentIndex = parentIndex;
    return this;
  }
  ...
  public Artifact withOffset(Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public Artifact withLength(Long length) {
    this.length = length;
    return this;
  }
  ...
  public int hashCode() {
    ...
    result =
        ((result * 31)
            + ((this.lastModifiedTimeUtc == null) ? 0 : this.lastModifiedTimeUtc.hashCode()));

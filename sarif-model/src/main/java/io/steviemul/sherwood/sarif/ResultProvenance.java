...
public class ResultProvenance {
     ...
     */
    public ResultProvenance(Date firstDetectionTimeUtc, Date lastDetectionTimeUtc, String firstDetectionRunGuid, String lastDetectionRunGuid, Long invocationIndex, Set<PhysicalLocation> conversionSources, PropertyBag properties) {
        super();

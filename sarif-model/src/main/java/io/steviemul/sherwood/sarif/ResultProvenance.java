...
public class ResultProvenance {
  ...
  private Long invocationIndex = -1L;
  ...
  /**
   * @param firstDetectionRunGuid A GUID-valued string equal to the automationDetails.guid property
   *     of the run in which the result was first detected.
   * @param lastDetectionTimeUtc The Coordinated Universal Time (UTC) date and time at which the
   *     result was most recently detected. See "Date/time properties" in the SARIF spec for the
   *     required format.
   * @param invocationIndex The index within the run.invocations array of the invocation object
   *     which describes the tool invocation that detected the result.
   * @param lastDetectionRunGuid A GUID-valued string equal to the automationDetails.guid property
   *     of the run in which the result was most recently detected.
   * @param conversionSources An array of physicalLocation objects which specify the portions of an
   *     analysis tool's output that a converter transformed into the result.
   * @param firstDetectionTimeUtc The Coordinated Universal Time (UTC) date and time at which the
   *     result was first detected. See "Date/time properties" in the SARIF spec for the required
   *     format.
   * @param properties Key/value pairs that provide additional information about the result.
   */
  public ResultProvenance(
      Date firstDetectionTimeUtc,
      Date lastDetectionTimeUtc,
      String firstDetectionRunGuid,
      String lastDetectionRunGuid,
      Long invocationIndex,
      Set<PhysicalLocation> conversionSources,
   ...
   */
  @JsonProperty("invocationIndex")
  public void setInvocationIndex(Long invocationIndex) {
    this.invocationIndex = invocationIndex;
  }

  public ResultProvenance withInvocationIndex(Long invocationIndex) {
    this.invocationIndex = invocationIndex;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(ResultProvenance.class.getName())
        .append('@')
  ...
  public int hashCode() {
    ...
    result =
        ((result * 31)
            + ((this.firstDetectionRunGuid == null) ? 0 : this.firstDetectionRunGuid.hashCode()));
    result =
        ((result * 31)
            + ((this.lastDetectionTimeUtc == null) ? 0 : this.lastDetectionTimeUtc.hashCode()));
    result =
        ((result * 31) + ((this.invocationIndex == null) ? 0 : this.invocationIndex.hashCode()));
    result =
        ((result * 31)
            + ((this.lastDetectionRunGuid == null) ? 0 : this.lastDetectionRunGuid.hashCode()));
    result =
        ((result * 31)
            + ((this.conversionSources == null) ? 0 : this.conversionSources.hashCode()));
    result =
        ((result * 31)
            + ((this.firstDetectionTimeUtc == null) ? 0 : this.firstDetectionTimeUtc.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return ((((((((this.firstDetectionRunGuid == rhs.firstDetectionRunGuid)
                                || ((this.firstDetectionRunGuid != null)
                                    && this.firstDetectionRunGuid.equals(
                                        rhs.firstDetectionRunGuid)))
                            && ((this.lastDetectionTimeUtc == rhs.lastDetectionTimeUtc)
                                || ((this.lastDetectionTimeUtc != null)
                                    && this.lastDetectionTimeUtc.equals(rhs.lastDetectionTimeUtc))))
                        && ((this.invocationIndex == rhs.invocationIndex)
                            || ((this.invocationIndex != null)
                                && this.invocationIndex.equals(rhs.invocationIndex))))
                    && ((this.lastDetectionRunGuid == rhs.lastDetectionRunGuid)
                        || ((this.lastDetectionRunGuid != null)
                            && this.lastDetectionRunGuid.equals(rhs.lastDetectionRunGuid))))
                && ((this.conversionSources == rhs.conversionSources)
                    || ((this.conversionSources != null)
                        && this.conversionSources.equals(rhs.conversionSources))))
            && ((this.firstDetectionTimeUtc == rhs.firstDetectionTimeUtc)
                || ((this.firstDetectionTimeUtc != null)
                    && this.firstDetectionTimeUtc.equals(rhs.firstDetectionTimeUtc))))

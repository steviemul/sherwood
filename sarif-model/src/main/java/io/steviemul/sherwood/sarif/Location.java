...
public class Location {
  ...
  /**
   * @param relationships An array of objects that describe relationships between this location and
   *     others.
   * @param physicalLocation Identifies the artifact and region.
   * @param logicalLocations The logical locations associated with the result.
   * @param annotations A set of regions relevant to the location.
   * @param id Value that distinguishes this location from all other locations within a single
   *     result object.
   * @param message A message relevant to the location.
   * @param properties Key/value pairs that provide additional information about the location.
   */
  public Location(
      Long id,
      ...
      Set<LocationRelationship> relationships,
  ...
  public int hashCode() {
    ...
    result =
        ((result * 31) + ((this.physicalLocation == null) ? 0 : this.physicalLocation.hashCode()));
    result =
  ...
  public boolean equals(Object other) {
    ...
    return ((((((((this.relationships == rhs.relationships)
                            ...
                            && ((this.physicalLocation == rhs.physicalLocation)
                                || ((this.physicalLocation != null)
                                    && this.physicalLocation.equals(rhs.physicalLocation))))
                        && ((this.logicalLocations == rhs.logicalLocations)
                            || ((this.logicalLocations != null)
                                && this.logicalLocations.equals(rhs.logicalLocations))))
                    && ((this.annotations == rhs.annotations)
                        || ((this.annotations != null)
                            && this.annotations.equals(rhs.annotations))))

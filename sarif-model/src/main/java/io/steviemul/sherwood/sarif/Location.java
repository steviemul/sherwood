...
public class Location {
     ...
     */
    public Location(Long id, PhysicalLocation physicalLocation, Set<LogicalLocation> logicalLocations, Message message, Set<Region> annotations, Set<LocationRelationship> relationships, PropertyBag properties) {
        super();
        this.id = id;

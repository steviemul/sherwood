...
public class ExternalPropertyFileReference {
  ...
  /**
   * @param guid A stable, unique identifer for the external property file in the form of a GUID.
   * @param location The location of the external property file.
   * @param properties Key/value pairs that provide additional information about the external
   *     property file.
   * @param itemCount A non-negative integer specifying the number of items contained in the
   *     external property file.
   */
  public ExternalPropertyFileReference(
      ArtifactLocation location, String guid, Long itemCount, PropertyBag properties) {
    super();
  ...
  public String toString() {
    ...
    sb.append(ExternalPropertyFileReference.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return (((((this.guid == rhs.guid) || ((this.guid != null) && this.guid.equals(rhs.guid)))
        ...
        && ((this.itemCount == rhs.itemCount)
            || ((this.itemCount != null) && this.itemCount.equals(rhs.itemCount))));
  }
}

...
public class LocationRelationship {
  ...
  /** A reference to the related location. (Required) */
  @JsonProperty("target")
  ...
  /**
   * @param description A description of the location relationship.
   ...
   */
  public LocationRelationship(
      Long target, Set<String> kinds, Message description, PropertyBag properties) {
    super();
    this.target = target;
    this.kinds = kinds;
  ...
  public LocationRelationship withTarget(Long target) {
    this.target = target;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(LocationRelationship.class.getName())
        .append('@')

...
@JsonPropertyOrder({"guid", "kind", "state", "justification", "location", "properties"})
...
public class Suppression {
  ...
  /** A string that indicates where the suppression is persisted. (Required) */
  @JsonProperty("kind")
   ...
   * @param guid A stable, unique identifer for the suprression in the form of a GUID.
   * @param location Identifies the location associated with the suppression.
   * @param state A string that indicates the state of the suppression.
   * @param justification A string representing the justification for the suppression.
   * @param properties Key/value pairs that provide additional information about the suppression.
   */
  public Suppression(
      String guid,
  ...
  public String toString() {
    ...
    sb.append(Suppression.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return (((((((this.guid == rhs.guid) || ((this.guid != null) && this.guid.equals(rhs.guid)))
                ...
                && ((this.justification == rhs.justification)
                    || ((this.justification != null)
                        && this.justification.equals(rhs.justification))))
  ...
  public enum Kind {
    ...
    private static final Map<String, Suppression.Kind> CONSTANTS =
        new HashMap<String, Suppression.Kind>();
  ...
  public enum State {
    ...
    REJECTED("rejected");
    private final String value;
    private static final Map<String, Suppression.State> CONSTANTS =
        new HashMap<String, Suppression.State>();

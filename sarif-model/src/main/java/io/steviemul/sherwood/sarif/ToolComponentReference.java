...
@JsonPropertyOrder({"name", "index", "guid", "properties"})
...
public class ToolComponentReference {
  ...
  /**
   * @param name The 'name' property of the referenced toolComponent.
   * @param index An index into the referenced toolComponent in tool.extensions.
   * @param guid The 'guid' property of the referenced toolComponent.
   * @param properties Key/value pairs that provide additional information about the
   *     toolComponentReference.
   */
  public ToolComponentReference(String name, Long index, String guid, PropertyBag properties) {
    super();
    this.name = name;
    this.index = index;
    this.guid = guid;
  ...
  public ToolComponentReference withIndex(Long index) {
    this.index = index;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(ToolComponentReference.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return (((((this.name == rhs.name) || ((this.name != null) && this.name.equals(rhs.name)))
            ...
            && ((this.guid == rhs.guid) || ((this.guid != null) && this.guid.equals(rhs.guid))))

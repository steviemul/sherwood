 ...
 * which holds message strings in plain text and (optionally) Markdown format. The strings can
 * include placeholders, which can be used to construct a message in combination with an arbitrary
...
public class MessageStrings {
  ...
  @JsonIgnore
  private Map<String, MultiformatMessageString> additionalProperties =
      new LinkedHashMap<String, MultiformatMessageString>();
  ...
  public String toString() {
    ...
    sb.append(MessageStrings.class.getName())
        .append('@')

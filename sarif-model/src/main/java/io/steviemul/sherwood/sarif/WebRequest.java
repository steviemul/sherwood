...
public class WebRequest {
   ...
   * @param protocol The request protocol. Example: 'http'.
   * @param method The HTTP method. Well-known values are 'GET', 'PUT', 'POST', 'DELETE', 'PATCH',
   *     'HEAD', 'OPTIONS', 'TRACE', 'CONNECT'.
   * @param index The index within the run.webRequests array of the request object associated with
   *     this result.
   * @param body The body of the request.
   * @param version The request version. Example: '1.1'.
   * @param parameters The request parameters.
   * @param properties Key/value pairs that provide additional information about the request.
  ...
  public WebRequest withIndex(Long index) {
    this.index = index;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append(WebRequest.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((((((((this.headers == rhs.headers)
                                ...
                                && ((this.method == rhs.method)
                                    || ((this.method != null) && this.method.equals(rhs.method))))
                ...
                && ((this.parameters == rhs.parameters)
                    || ((this.parameters != null) && this.parameters.equals(rhs.parameters))))

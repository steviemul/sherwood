...
public class WebRequest {
     ...
     *     The target of the request.
     */
    public WebRequest(Long index, String protocol, String version, String target, String method, Headers headers, Parameters parameters, ArtifactContent body, PropertyBag properties) {
        super();
        this.index = index;

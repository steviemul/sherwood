...
@JsonPropertyOrder({"id", "label", "location", "children", "properties"})
@Generated("jsonschema2pojo")
public class Node {

  /** A string that uniquely identifies the node within its graph. (Required) */
  @JsonProperty("id")
   ...
   * @param location A code location associated with the node.
   * @param id A string that uniquely identifies the node within its graph.
   * @param label A short description of the node.
   * @param properties Key/value pairs that provide additional information about the node.
   */
  public Node(
      String id, Message label, Location location, Set<Node> children, PropertyBag properties) {
    super();
    this.id = id;
    this.label = label;

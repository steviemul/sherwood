...
@JsonPropertyOrder({"message", "threadFlows", "properties"})
...
public class CodeFlow {
   ...
   * program through a thread of execution. (Required)
   */
  ...
  /**
   * @param message A message relevant to the code flow.
   * @param threadFlows An array of one or more unique threadFlow objects, each of which describes
   *     the progress of a program through a thread of execution.
   * @param properties Key/value pairs that provide additional information about the code flow.
   */
  ...
  public String toString() {
    ...
    sb.append(CodeFlow.class.getName())
        .append('@')
  ...
  public boolean equals(Object other) {
    ...
    return ((((this.message == rhs.message)
            ...
            && ((this.threadFlows == rhs.threadFlows)
                || ((this.threadFlows != null) && this.threadFlows.equals(rhs.threadFlows))))

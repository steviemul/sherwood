...
public class ThreadFlowLocation {
  ...
  private ThreadFlowLocation.Importance importance =
      ThreadFlowLocation.Importance.fromValue("important");
  ...
  /**
   * @param taxa An array of references to rule or taxonomy reporting descriptors that are
   *     applicable to the thread flow location.
   * @param nestingLevel An integer representing a containment hierarchy within the thread flow.
   * @param stack The call stack leading to this location.
   * @param webRequest A web request associated with this thread flow location.
   * @param importance Specifies the importance of this location in understanding the code flow in
   *     which it occurs. The order from most to least important is "essential", "important",
   *     "unimportant". Default: "important".
   * @param module The name of the module that contains the code that is executing.
   * @param executionTimeUtc The Coordinated Universal Time (UTC) date and time at which this
   *     location was executed.
   * @param index The index within the run threadFlowLocations array.
   * @param kinds A set of distinct strings that categorize the thread flow location. Well-known
   ...
   * @param executionOrder An integer representing the temporal order in which execution reached
   *     this location.
   * @param webResponse A web response associated with this thread flow location.
   * @param location The code location.
   * @param state A dictionary, each of whose keys specifies a variable or expression, the
   *     associated value of which represents the variable or expression value. For an annotation of
   *     kind 'continuation', for example, this dictionary might hold the current assumed values of
   *     a set of global variables.
   * @param properties Key/value pairs that provide additional information about the threadflow
   *     location.
   */
  public ThreadFlowLocation(
      Long index,
  ...
  public String toString() {
    ...
    sb.append(ThreadFlowLocation.class.getName())
        .append('@')
  ...
  public int hashCode() {
    ...
    result =
        ((result * 31) + ((this.executionTimeUtc == null) ? 0 : this.executionTimeUtc.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return (((((((((((((((this.taxa == rhs.taxa)
                                                            || ((this.taxa != null)
                                                                && this.taxa.equals(rhs.taxa)))
                                                        && ((this.nestingLevel == rhs.nestingLevel)
                                                            || ((this.nestingLevel != null)
                                                                && this.nestingLevel.equals(
                                                                    rhs.nestingLevel))))
                                                    && ((this.stack == rhs.stack)
                                                        || ((this.stack != null)
                                                            && this.stack.equals(rhs.stack))))
                                                && ((this.webRequest == rhs.webRequest)
                                                    || ((this.webRequest != null)
                                                        && this.webRequest.equals(rhs.webRequest))))
                                            && ((this.importance == rhs.importance)
                                                || ((this.importance != null)
                                                    && this.importance.equals(rhs.importance))))
                                        && ((this.module == rhs.module)
                                            || ((this.module != null)
                                                && this.module.equals(rhs.module))))
                                    && ((this.executionTimeUtc == rhs.executionTimeUtc)
                                        || ((this.executionTimeUtc != null)
                                            && this.executionTimeUtc.equals(rhs.executionTimeUtc))))
                                && ((this.index == rhs.index)
                                    || ((this.index != null) && this.index.equals(rhs.index))))
                            && ((this.kinds == rhs.kinds)
                                || ((this.kinds != null) && this.kinds.equals(rhs.kinds))))
                        && ((this.executionOrder == rhs.executionOrder)
                            || ((this.executionOrder != null)
                                && this.executionOrder.equals(rhs.executionOrder))))
  ...
  public enum Importance {
    ...
    private static final Map<String, ThreadFlowLocation.Importance> CONSTANTS =
        new HashMap<String, ThreadFlowLocation.Importance>();
